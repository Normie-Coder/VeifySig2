...
public class Config {
    ...
    private static final String REQUIRED_MPI_VERSION = "1-58";
    ...
    private static String downloaded_MPI_Version = "";
    private static String downloaded_MPI_Conf_Version = "";
    private static String downloaded_OS_Version = "";
    private static String downloaded_OS_Conf_Version = "";

    public static String getDownloaded_MPI_Version(){
      return downloaded_MPI_Version;
    }

    public static void setDownloaded_MPI_Version(String _downloaded_MPI_Version){
      downloaded_MPI_Version = _downloaded_MPI_Version;
    }

    public static String getDownloaded_OS_Version(){
    return downloaded_OS_Version;
  }

    public static void setDownloaded_OS_Version(String _downloaded_OS_Version){
      downloaded_OS_Version = _downloaded_OS_Version;
    }

    public static String getDownloaded_MPI_Conf_Version(){
      return downloaded_MPI_Conf_Version;
    }

    public static void setDownloaded_MPI_Conf_Version(String _downloaded_MPI_Conf_Version){
      downloaded_MPI_Conf_Version = _downloaded_MPI_Conf_Version;
    }

  public static String getDownloaded_OS_Conf_Version(){
    return downloaded_OS_Conf_Version;
  }

  public static void setDownloaded_OS_Conf_Version(String _downloaded_OS_Conf_Version){
    downloaded_OS_Conf_Version = _downloaded_OS_Conf_Version;
  }
    ...
    private static final String OS_UPDATE_FILE_NAME = "M000-TESTOS-V9-2.tar.gz";
    //private static final String OS_UPDATE_FILE_NAME = "M000-TESTOS-V9-2.tar.gz";
    ...
    //private static final String TEST_MPI_CONF_FILE_NAME = "M000-TESTMPI-Vx-x-CONF00-V6.tar.gz";
     private static final String TEST_MPI_CONF_FILE_NAME = "M000-TESTMPI-Vx-x-CONF00-V7.tar.gz";
    ...
    public static void setBluetoothName(String name, Context context){
        SharedPreferences prefs = context.getSharedPreferences("DevicePreferences", Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = prefs.edit();
        editor.putString("DeviceMpressBluetoothName", name);
        editor.commit();
    }
}
